...
<head>
  ...
  <script src="../public/js/widget-core.js"></script>
  <script src="../ajax/get/bundler.php?w=*" id="widgets-scripts"></script>
  <link rel="stylesheet" href="../ajax/get/bundler.php?w=*&ftype=css" id="widgets-styles">
  <script src="../widgets/root/root.js"></script>
