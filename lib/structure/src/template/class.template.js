var W__class_name__ = class W__class_name__ extends Widget { // var is used because it creates reference on globalThis (window) object
  ...
  static default (parent) {
    return new W__class_name__(html({}), parent);
  }
